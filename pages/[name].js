  ...
  return (
    ...
    >
      ...
      <div className="seo_banner">
        <div
          className="row seo-row m-0"
          style={{
            backgroundColor: isMobile ? "#0a56a5e3" : "#4381c0",
          }}
        >
          {!isMobile && (
            ...
            <div className="bnr_rt_wrap">
              ...
              <div className="bnr_dec">
                ...
                <p>
                  ...
                  {car?.vehicles?.[0]?.make}. Then, book an appointment to sell.
                  Our friendly car concierge will come to your driveway to pay &
